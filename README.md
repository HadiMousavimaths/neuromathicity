...
**Key Features:**
*   **Deep Focus Timer:** A dedicated space and countdown to manage cognitive load.
*   **The Journey:** Track your progress through math textbooks and resources.
*   **XP & Leveling System:** Earn experience points based on reading and problem-solving milestones.
...
### Prerequisites
Requirements:
PyQt5 (For the interface and timer)
pyqtgraph & numpy (For the analytics and node view)
type this one-line command in your Command Prompt to install the required libraries before running the files.
```bash
pip install PyQt5 pyqtgraph numpy
**run the database file just once first and then run the main.py file.**
